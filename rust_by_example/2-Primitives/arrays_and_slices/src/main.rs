...
// memory. Arrays are created suing brackets [], and their lenght, which is known
...
// usize, determined by the processor architecture eg 64 bits on the x86-64.
...
fn main() {
    ...
    // `.expect()` if you wuold like the program to exit with a nice
    // message instead of happily continue.
    for i in 0..xs.len() + 1 { // OOPS, one eleent too far
        match xs.get(i) {
