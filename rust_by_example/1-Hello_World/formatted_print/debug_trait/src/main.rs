// All types which want to use std::fmt formatting traits requires an implementation to
// be printable. Automatic implementation are only provided for types such as in the std
// library. All others must be manually implementated somehow.
//
