// Functions are declared using the fn keyword. It's arguments are type annotated,
// just like variables, and, if the function returns a value, the return type must
// be specified after and array ->
...
// Unlike C/C++, there's no restruction on the order of function definitions
...
// When a function returns `()`, the return type can be ommitted from the
// signature
